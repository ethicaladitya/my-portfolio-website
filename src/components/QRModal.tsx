        ...
        >
          ...
          >
            ...
            <div className="text-center mb-6">
              <div className="inline-flex w-14 h-14 rounded-2xl bg-gradient-to-br from-purple-500 to-blue-500 items-center justify-center text-white mb-4 shadow-glow">
            ...
            <div className="flex justify-center mb-6">
              <div className="p-3 rounded-2xl bg-gradient-to-br from-purple-50 to-blue-50 border border-purple-100">
